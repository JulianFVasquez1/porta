...
export const StoriesContent = ({
  ...
  <CarouselContent className={cn('gap-4 md:gap-6 -ml-0', className)} {...props} />
);
...
export const Story = ({ className, ...props }: StoryProps) => (
  <CarouselItem className="basis-auto pl-0">
    <div
      className={cn(
        'group relative overflow-hidden rounded-2xl bg-zinc-900/60 border border-zinc-800',
        'cursor-pointer transition-all duration-300',
        'hover:scale-[1.03] hover:shadow-2xl hover:border-yellow-400/60',
