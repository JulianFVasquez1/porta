        ...
        <div className="mt-6 flex items-center justify-center gap-3">
          ...
          {activeItem.href ? (
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="text-zinc-400 hover:text-yellow-400 transition ml-2"
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-6 pt-2 bg-gradient-to-t from-zinc-950 via-zinc-950/95 to-transparent">
        ...
        {item.description ? (
          <p className="mt-1.5 line-clamp-2 text-xs md:text-sm text-zinc-300 font-light leading-relaxed">
            {item.description}
          </p>
        ) : null}
      </div>
